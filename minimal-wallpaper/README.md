# Minimal Phone Wallpaper

Official prompt template for minimal mobile wallpapers with clear subject, calm composition, and generous negative space.

## Install

```bash
bananahub add bananahub-ai/templates/minimal-wallpaper
```
